...
export const COLUMN_STYLES: Record<ColumnStyleKey, ColumnStyleEntry> = {
  ...
  "square-pilaster": {
    ...
    compatibleStyles: ["colonial", "mediterranean", "modern-minimalist", "craftsman", "tropical"],
  ...
  "steel-section": {
    ...
    compatibleStyles: ["industrial", "mid-century"],
  ...
  "board-strip": {
    ...
    compatibleStyles: ["nordic", "craftsman", "mid-century"],
