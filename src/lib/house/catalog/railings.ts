...
export const RAILING_STYLES: Record<RailingStyleKey, RailingStyleEntry> = {
  ...
  "cable": {
    ...
    compatibleStyles: ["modern-minimalist", "mid-century", "industrial", "nordic", "tropical"],
  ...
  "glass-panel": {
    ...
    compatibleStyles: ["modern-minimalist", "tropical", "nordic", "mid-century"],
  ...
  "picket": {
    ...
    compatibleStyles: ["colonial", "craftsman"],
