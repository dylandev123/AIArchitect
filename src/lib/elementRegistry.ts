...
const ALL: ElementEntry[] = [
  ...
  },
  {
    ...
    group: "build",
    allowedTypes: ["house", "villa"],
    action: { kind: "add-feature", featureType: "porch" },
  },
  {
    id: "chimney",
    label: "Chimney",
    ...
    group: "build",
    allowedTypes: ["house", "villa"],
    action: { kind: "add-feature", featureType: "chimney" },
  },
  {
    id: "stairs",
    label: "Stairs",
    ...
    group: "build",
    allowedTypes: ["house", "villa", "commercial"],
    action: { kind: "add-feature", featureType: "stairs" },
  },
  {
    id: "bay",
    label: "Bay / Turret",
    ...
    group: "build",
    allowedTypes: ["house", "villa"],
    action: { kind: "add-feature", featureType: "bay" },
  },
  {
    id: "arch",
    label: "Arch",
    ...
    group: "build",
    allowedTypes: ["house", "villa", "commercial"],
    action: { kind: "add-feature", featureType: "arch" },
  },
  {
    id: "dormer",
    label: "Dormer",
    ...
    group: "build",
    allowedTypes: ["house", "villa"],
    action: { kind: "add-feature", featureType: "dormer" },
  },
  {
    id: "crossGable",
    label: "Cross Gable",
    ...
    group: "build",
    allowedTypes: ["house", "villa"],
    action: { kind: "add-feature", featureType: "crossGable" },
  },
  {
    id: "foundation",
    label: "Foundation",
    ...
    group: "build",
    allowedTypes: ["house", "villa"],
    action: { kind: "add-feature", featureType: "foundation" },
  },
  {
    id: "fence",
    label: "Fence",
  ...
  },
  {
    ...
    icon: Trees,
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-landscape", landscapeKind: "clearing" },
  },

  {
    ...
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-feature", featureType: "curvedWall" },
  },
  {
    id: "retainingWall",
    ...
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-feature", featureType: "retainingWall" },
  },
  {
    id: "path",
    label: "Path",
    ...
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-feature", featureType: "path" },
  },
  {
    id: "waterway",
    label: "River / Stream",
    ...
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-feature", featureType: "waterway" },
  },
  {
    id: "rockCluster",
    label: "Rocks",
    ...
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-feature", featureType: "rockCluster" },
  },
  {
    id: "slope",
    label: "Slope / Mound",
    ...
    group: "outdoor",
    allowedTypes: ["house", "villa", "resort"],
    action: { kind: "add-feature", featureType: "slope" },
  },
