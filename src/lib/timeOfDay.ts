...
export const TIME_OF_DAY: Record<TimeOfDay, TimeOfDayConfig> = {
  morning: {
    ...
    ambient: { intensity: 0.24, color: "#ffe8cc" },
  ...
  midday: {
    ...
    ambient: { intensity: 0.30, color: "#f0f5ff" },
    hemi:  { sky: "#c0d4ff", ground: "#6aaa48", intensity: 0.42 },
    fills: [
      { position: [-22, 18, -14], intensity: 0.18, color: "#dde8ff" },
